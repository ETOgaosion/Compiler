...
void IRAssignB::genTargetCode(TargetCodes *t) {
    ...
    if (result->getIsArray()) {
        ...
        for (int i = 0; i < result->getArraySize(); ++i) {
            ...
            t->addCodeStore(arg1Reg, tmpr, 0, FloatPointType::NONE);
        }
        t->setRegisterFree(true, arg1Reg);
