...
public:
  ...
  enum {
    ...
    RuleMulExp = 26, RuleMulOp = 27, RuleAddExp = 28, RuleAddOp = 29, RuleRelExp = 30, 
    RuleRelOp = 31, RuleEqExp = 32, RuleEqOp = 33, RuleLAndExp = 34, RuleLOrExp = 35, 
    RuleConstExp = 36, RuleNumber = 37
  };
